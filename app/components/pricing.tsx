    ...
    <section id="pricing" className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-white">Available plans for your fans</h2>
          <p className="text-lg text-gray-600 dark:text-gray-200">Give supporters the experience you want them to have with your AI persona.</p>
        </div>
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-stretch gap-8">
          {/* Free Plan */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-md flex flex-col">
            <h3 className="text-3xl font-bold text-left mb-4">Free</h3>
            <p className="text-gray-600 dark:text-gray-200 text-left mb-6">Start conversations. No commitments.</p>
          ...
          {/* Premium Plan */}
          <div 
            className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-md flex flex-col border-2 border-blue-600 relative"
            style={{
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-200 text-left mb-6">Monetize deeper fan experiences.</p>
            <div className="text-left mb-8">
              <span className="text-5xl font-bold">$X</span> {/* Placeholder for price */}
              <span className="text-gray-600 dark:text-gray-200">/month</span>
              <div className="flex items-center mt-2">
                <InfoIcon className="w-4 h-4 text-gray-400 dark:text-gray-200 mr-2" />
                <p className="text-sm text-gray-500 dark:text-gray-200 font-medium">You set your own pricing and keep full control</p>
              </div>
            </div>
            <ul className="space-y-4 flex-grow mb-8 text-left">
              <PricingFeature text="24/7 AI bot access" available={true} />
        ...
        <div className="text-center mt-12">
          <Link
            ...
            className="inline-block bg-blue-600 text-white dark:text-gray-900 py-4 px-8 rounded-lg text-xl font-semibold hover:bg-blue-700 transition-colors cursor-pointer"
          >
