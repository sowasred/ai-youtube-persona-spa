...
export const AnimatedTooltip = ({
  ...
  const handleMouseEnter = (id: number, event?: React.MouseEvent<HTMLDivElement>) => {
  ...
  const handleAvatarTap = (id: number, event: React.MouseEvent<HTMLButtonElement>) => {
    if (!isTouchDevice) return;
    const newHoverState = hoveredIndex === id ? null : id;
    setHoveredIndex(newHoverState);
        ...
        >
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              <div className={getTooltipClasses(item.id)}>
                ...
                >
                  {item.telegramLink && (
                    <a
                      ...
                      className="px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white text-sm sm:text-lg font-medium rounded-full transition-colors duration-200 flex items-center gap-1 shadow-lg hover:shadow-xl"
                    >
                  ...
                  {item.whatsappLink && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white text-sm sm:text-lg font-medium rounded-full transition-colors duration-200 flex items-center gap-1 shadow-lg hover:shadow-xl"
                    >
                      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {item.youtubeLink && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="px-3 py-1.5 bg-red-500 hover:bg-red-600 text-white text-sm sm:text-lg font-medium rounded-full transition-colors duration-200 flex items-center gap-1 shadow-lg hover:shadow-xl"
                    >
